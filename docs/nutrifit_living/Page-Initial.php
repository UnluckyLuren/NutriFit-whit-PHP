    ...
    <div class="faq" id="faq">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <h2 class="faqTitle" >Preguntas Frecuentes</h2>
                </div>
                <div class="col-lg-7">
            ...
            <div class="modal modalVentInitial">
                <div class="compra">       
                    ...
                    <div class="btnUsuarioControl">
                        ...
                        <div class="info-text updateImageUserGratis">
...
<!--  Ventana Emergente Update usuario desbloquear funciones -->


<div class="updateUnlock disNone" id="updateUnlock">

    <h2>Para acceder a está funcionalidad sube de nivel tú cuenta</h2>
    ...
    <footer class="containerfooter objDisplay footerPageInitial" id="footerDieta" >
        <div class="item-1">
            <div class="imagen">
                <figure>
