...
<div class="containerSECCIONES">
    <nav class="menuSECCIONES">
        <ul>
            <li><a href="lacteos.php"><p class="nombreDEpaginadondeseencuantraSECCIONES"> ▼  Lacteos</p></a>
...
<pre class="titulo_de_equivalencias">Mapa de equivalencias (Lacteos)</pre>
<br>
<div class="centarcontentEquivalencias">                               
    <div class="containerEquivalencias">                      
                                                
    <div class="itemsEquvalencias"><a href="/nutrifit living/productos.php">Leche descremada --------- 1 taza</a> </div>
                                                                                      
                                                                
    <div class="itemsEquvalencias"><a href="/nutrifit living/productos.php">Leche de soya o almendras--- 1 taza</a>    </div>                                                     
    

    <div class="itemsEquvalencias"><a  href="/nutrifit living/productos.php">Yogurt light----3/4 taza</a></div>


    <div class="itemsEquvalencias"><a  href="/nutrifit living/productos.php">Yogurt griego-----1/2 taza</a></div>
...
<br><br>
    ...
    <script src="../Prueba/java.js"></script>
