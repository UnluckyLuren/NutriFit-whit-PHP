...
<header class="header">
        <nav class="nav">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-menu-item OpCero"><a href="#" class="nav-menu-link nav-link">Servicios</a></li>
                <li class="nav-menu-item OpCero"><a href="#" class="nav-menu-link nav-link">Recetario</a></li>
            </ul>
