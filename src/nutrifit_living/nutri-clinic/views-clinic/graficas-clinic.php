...
echo '<h2 class="titlePageSlc">Avances</h2> ';
...
<div class="slcGraficas">
<label class="labFormIngre" >Paciente:</label>
         ...
         <?php 
            ...
            for ($i=0; $i<$AllUsers; $i++) {
                ...
                if ($i == $idDeJS) {
                    ...
                    if ($AllUsers-1 == $idDeJS) {
                        echo
                        '<input class="selectopt" name="test" type="radio" id="opt'.$idDeJS.'" value="#" onclick="metPostJX('."'graficas-clinic'".','.$idDeJS.'); graficasView('.$idDeJS.')" >
                        <label for="opt'.$idDeJS.'" class="option" > ID: '.$DatosIds[$idDeJS][0].' Nombre: '.$DatosNombres[$idDeJS][0].'</label>';
                    } else {
                        echo "";
                    }

                } else if ( $AllUsers-1 == $i) {

                    echo 
                    '<input class="selectopt" name="test" type="radio" id="opt'.$i.'" value="#" onclick="metPostJX('."'graficas-clinic'".','.$i.'); graficasView('.$i.')" >
                    <label for="opt'.$i.'" class="option" > ID: '.$DatosIds[$i][0].' Nombre: '.$DatosNombres[$i][0].'</label>';
...
<div class="categorias catGraficas" id="categorias">
    ...
    <div class="preguntas preGrafics">

    <?php  // Información de cada ususario
    ...
    ?>
        ...
        <div class="contenedor-preguntas" data-categoria="entregas">
            <div class="contenedor-pregunta conPregBord">
        ...
        <div class="contenedor-preguntas" data-categoria="seguridad">
            <div class="contenedor-pregunta conPregBord">
                ...
                <p class="respuesta conPregPacientes"> <canvas class="graficados"></canvas> <canvas class="graficados"></canvas> </p>
            </div>
            <div class="contenedor-pregunta conPregBord">
