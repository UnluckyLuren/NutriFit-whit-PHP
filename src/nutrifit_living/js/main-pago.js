...
visa.addEventListener('click', () => {
	...
	delantera.style.background = "url(imagenes/img-pago/bg-tarjeta/modelo-visa.png)"
	Remove_bank()
	nombrebank.style.display = "none"
	logo.src="imagenes/img-pago/logos/visa.png"
...
mastercard.addEventListener('click', () => {
	delantera.classList.add('fondodetarjeta')
	delantera.style.background = "url(imagenes/img-pago/bg-tarjeta/modelo-mastercard.png)"
	Remove_bank()
	nombrebank.style.display = "none"
	logo.src="imagenes/img-pago/logos/mastercard.png"
	logoMarca.appendChild(logo)
...
paypal.addEventListener('click', () => {
	delantera.classList.add('fondodetarjeta')
	delantera.style.background = "url(imagenes/img-pago/bg-tarjeta/modelo-paypal.png)"
	Remove_bank()
	nombrebank.style.display = "none"
	logo.src="imagenes/img-pago/logos/logo-Paypal.png"
	logoMarca.appendChild(logo)
	logo.style.height = "3.5em"
})
...
santander.addEventListener('click', () => {
	delantera.classList.add('fondodetarjeta')
	delantera.style.background = "url(imagenes/img-pago/bg-tarjeta/modelo-santander.png)"
	Remove_bank()
	nombrebank.style.display = "none"
	logo.src="imagenes/img-pago/logos/Logo-santander.png"
	logoMarca.appendChild(logo)
