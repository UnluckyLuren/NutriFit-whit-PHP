...
<div class="container">
 ...
 <div class="containerSECCIONES">
    <nav class="menuSECCIONES">
        <ul>
            <li><a href="Cereales_Carbohidratos.php"><p class="nombreDEpaginadondeseencuantraSECCIONES"> ▼   Cereales/Carbohidratos</p></a>
...
<pre class="titulo_de_servicios_productos">Cereales/carbohidratos</pre>
...
<footer class="containerfooter">
        ...
        <div class="imagen">
            <!-- <figure> -->
                ...
                <a href="/nutrifit living/index (1).php">
                    <img class="ImagenFooterOpccion2" src="/Nuevo proyecto.png" alt="Logo de nutrifit living">
                </a>
            <!-- </figure> -->
        </div>
   ...
   <a class="item-2" href="../Termsycondiciones.php">TERMINOS Y CONDICIONES</a>
    ...
    <script src="../js/create-html-cereales.js"></script>
